...
var API = (function() {
  ...
  consume.saveLinks = function(links) {

    request.post(this.API_BASE_URL + '/joblinks', links);

  };

  consume.saveJobPost = function(post) {

    request.post(this.API_BASE_URL + '/jobposts', post);
